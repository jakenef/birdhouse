...
export function buildEarnestInboundSignalPrompt(
  ...
  return [
    ...
    '- confirm_wire_sent only when earnest_signal is wire_instructions_provided and the buyer now needs to manually send money',
    '- confirm_earnest_complete only when earnest_signal is earnest_received_confirmation and the buyer can now confirm earnest is complete',
    "- none otherwise",
